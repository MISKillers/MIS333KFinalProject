<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SavingsAccountDetails.aspx.vb" Inherits="LonghornBank.SavingsAccountDetails" %>
...
<body>
    ...
    <div>
        ...
        <label for="SavingsAccountDetails" style="font-size: 22px">Savings Account Details</label><br />
        <br />
...
&nbsp;<br />
        ...
        <asp:Button ID="btnSearch" type="button" runat="server" Text="Search" class="btn btn-primary" Height="40px" Width="210px"/>
